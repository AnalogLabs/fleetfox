...
bcinterface.py
--------------------------------------------
Fleet Fox - Blockchain Messaging Service
--------------------------------------------
Omar Metwally, MD (omar@analog.earth)
https://github.com/AnalogLabs/fleetfox
--------------------------------------------
'''
import os, json
...
class BCInterface:
    ...
    def load_contract(self,contract_name="fleetcoin",sender_address=None,contract_address="0xe18FE4Ded62a8aa723D6BE485B355d39d409354d"):
    ...
    def set_account(self,index):
        if len(self.eth_accounts) ==0:
            ...
            self.tx['from'] = self.eth_accounts[self.account_index]
